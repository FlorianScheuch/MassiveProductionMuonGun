...
namespace ROOT {
   static TClass *L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat_Dictionary();
   static void L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat_TClassManip(TClass*);
   static void *new_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat(void *p = 0);
   static void *newArray_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat(Long_t size, void *p);
   static void delete_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat(void *p);
   static void deleteArray_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat(void *p);
   static void destruct_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat*)
   {
      ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat));
      static ::ROOT::TGenericClassInfo 
         instance("L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat", "L1Trigger/L1TNtuples/interface/L1AnalysisL1UpgradeTfMuonDataFormat.h", 8,
                  typeid(::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat_Dictionary, isa_proxy, 0,
                  sizeof(::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat) );
      instance.SetNew(&new_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat);
      instance.SetNewArray(&newArray_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat);
      instance.SetDelete(&delete_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat);
      instance.SetDeleteArray(&deleteArray_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat);
      instance.SetDestructor(&destruct_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat*)
   {
      return GenerateInitInstanceLocal((::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat*)0x0)->GetClass();
      L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat : new ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat;
   }
   static void *newArray_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat[nElements] : new ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat[nElements];
   }
   // Wrapper around operator delete
   static void delete_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat(void *p) {
      delete ((::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat*)p);
   }
   static void deleteArray_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat(void *p) {
      delete [] ((::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat*)p);
   }
   static void destruct_L1AnalysiscLcLL1AnalysisL1UpgradeTfMuonDataFormat(void *p) {
      typedef ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat
...
namespace L1Analysis{struct __attribute__((annotate("$clingAutoload$L1Trigger/L1TNtuples/interface/L1AnalysisL1UpgradeTfMuonDataFormat.h")))  L1AnalysisL1UpgradeTfMuonDataFormat;}
...
"L1Analysis::L1AnalysisL1UpgradeTfMuonDataFormat", payloadCode, "@",
