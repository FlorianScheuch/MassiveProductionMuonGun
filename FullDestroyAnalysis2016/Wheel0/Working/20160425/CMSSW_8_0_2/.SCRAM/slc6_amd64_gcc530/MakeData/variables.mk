...
CMSSW_BASE:=/disk1/scheuch/grid/FullDestroyAnalysis2016/Wheel0/Working/20160425/CMSSW_8_0_2
...
CLHEP_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/clhep/2.2.0.4-ikhhed
...
HERWIG_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/herwig/6.521-ikhhed2
LAPACK_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/lapack/3.3.1-ikhhed
PY2_PANDAS_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/py2-pandas/0.17.1
...
ROOTRFLX_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.06.00-ikhhed2
...
RIVET_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/rivet/2.4.0-ikhhed
...
XROOTD_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/xrootd/4.0.4-ikhhed
...
JIMMY_HEADERS_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/jimmy/4.2-ikhhed2
...
LLVM_CCOMPILER_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/3.7.1
ifeq ($(strip $(SCRAM_COMPILER)),llvm)
CC:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/3.7.1/bin/clang
endif
...
CASCADE_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/cascade/2.2.04-ikhhed2
...
MCTESTER_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/mctester/1.25.0a-ikhhed2
...
PY2_MATPLOTLIB_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/py2-matplotlib/1.2.1-ikhhed
...
PYMINUIT2_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/pyminuit2/0.0.1-ikhhed2
YAML_CPP_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/yaml-cpp/0.5.1-ikhhed
XZ_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/xz/5.2.1
LLVM_ANALYZER_CXXCOMPILER_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/3.7.1
ifeq ($(strip $(SCRAM_COMPILER)),llvm-analyzer)
CXX:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/3.7.1/bin/c++-analyzer
endif
...
LLVM_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/3.7.1
...
SHERPA_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/sherpa/2.2.0-ikhhed3
...
FASTJET_CONTRIB_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/fastjet-contrib/1.020
GEANT4CORE_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/geant4/10.00.p03-ikhhed
G4LIB:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/geant4/10.00.p03-ikhhed/lib
FFTW3_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/fftw3/3.3.2
THEPEG_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/thepeg/1.9.2p1-ikhhed2
PY2_DOCOPT:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/py2-docopt/0.6.2-ikhhed
LLVM_ANALYZER_CCOMPILER_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/3.7.1
ifeq ($(strip $(SCRAM_COMPILER)),llvm-analyzer)
CC:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/3.7.1/bin/ccc-analyzer
endif
...
LHAPDF_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/lhapdf/6.1.6
...
export CCACHE_BASEDIR:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_8_0_2
endif
...
MILLEPEDE_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/millepede/V04-03-03
...
CURL_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/curl/7.46.0-ikhhed
...
GEANT4STATIC_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/geant4/10.00.p03-ikhhed
ifeq ($(strip $(SCRAM_COMPILER)),ccache)
...
PYCLANG_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/3.7.1
...
PY2_DXR_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/py2-dxr/1.0-ikhhed2
...
PY2_NUMPY_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/py2-numpy/1.9.2-ikhhed
HECTOR_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/hector/1.3.4_patch1-ikhhed2
...
GEANT4_PARFULLCMS:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/geant4-parfullcms/2014.01.27-ikhhed
...
ROOTCLING_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.06.00-ikhhed2
TKONLINESW_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/tkonlinesw/2.7.0
...
PY2_NETWORKX:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/py2-networkx/1.8.1-ikhhed
KTJET_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/ktjet/1.06-ikhhed
VDT_HEADERS_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/vdt/v0.3.2-ikhhed
VDT_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/vdt/v0.3.2-ikhhed
PYTHIA8_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/pythia8/212-ikhhed3
...
CASCADE_HEADERS_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/cascade/2.2.04-ikhhed2
ifeq ($(strip $(SCRAM_COMPILER)),distcc)
...
PY2_PYCURL_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/py2-pycurl/7.19.3.1-ikhhed
PROFESSOR_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/professor/1.4.0-ikhhed2
ROOT_INTERFACE_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.06.00-ikhhed2
HERWIGPP_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/herwigpp/2.7.1-ikhhed2
CASTOR_HEADER_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/castor/2.1.13.9
TAUOLAPP_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/tauolapp/1.1.5-ikhhed3
...
DAVIX_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/davix/0.4.0-ikhhed
CORAL_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/coral/CORAL_2_3_21-ikhhed4
...
CLHEPHEADER_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/clhep/2.2.0.4-ikhhed
JIMMY_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/jimmy/4.2-ikhhed2
CGAL_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/cgal/4.2-ikhhed
EVTGEN_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/evtgen/1.5.0-ikhhed3
GIT_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/git/1.8.3.1-ikhhed
PY2SHIPY_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/py2-scipy/0.8.0-ikhhed
...
IGPROF_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/igprof/5.9.14-ikhhed
...
LLVM_CXXCOMPILER_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/3.7.1
ifeq ($(strip $(SCRAM_COMPILER)),llvm)
CXX:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/3.7.1/bin/clang++
endif
TOPREX_HEADERS_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/toprex/4.23
ROOFIT_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.06.00-ikhhed2
...
CHARYBDIS_BASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/charybdis/1.003-ikhhed2
...
LOCALTOP:=/disk1/scheuch/grid/FullDestroyAnalysis2016/Wheel0/Working/20160425/CMSSW_8_0_2
SCRAM_TMP:=tmp
SCRAM_INIT_LOCALTOP:=/disk1/scheuch/grid/FullDestroyAnalysis2016/Wheel0/Working/20160425/CMSSW_8_0_2
SCRAM_BUILDFILE:=BuildFile
RELEASETOP:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_8_0_2
SCRAM_INTlog:=logs
...
SCRAM_SOURCEDIR:=src
SCRAM_RTBOURNE_SET:=CMSSW:CMSSW_8_0_2:slc6_amd64_gcc530:V2_2_6_pre5:SRT_
SCRAM_CONFIGCHKSUM:=V05-05-08
SCRAM_LOOKUPDB_WRITE:=/cvmfs/cms.cern.ch
SCRAM_PROJECTVERSION:=CMSSW_8_0_2
